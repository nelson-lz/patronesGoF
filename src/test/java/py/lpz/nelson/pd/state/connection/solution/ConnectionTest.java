...
class ConnectionTest {
    ...
    void testInitialState() {
        Assertions.assertEquals(State.CLOSED, this.connection.getState());
    }

    @Test
    void testClosedOpen() {
        this.connection.open();
        Assertions.assertEquals(State.READY, this.connection.getState());
    }
    ...
    void testReadyStop() {
        ...
        Assertions.assertEquals(State.STOPPED, this.connection.getState());
    }
    ...
    void testReadySubmit() {
        ...
        Assertions.assertEquals(State.WAITING, this.connection.getState());
    }
