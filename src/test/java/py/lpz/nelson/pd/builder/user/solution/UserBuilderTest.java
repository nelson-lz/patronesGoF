package py.lpz.nelson.pd.builder.user.solution;

import py.lpz.nelson.pd.builder.user.User;
...
class UserBuilderTest {
    ...
    @Test
    void testFull() {
        py.lpz.nelson.pd.builder.user.User user = new UserBuilder(1, "Paco").name("Jose").familyName("De Miguel").phone(666666666).adult()
    ...
    void testTagContainsFalseNullTags() {
        py.lpz.nelson.pd.builder.user.User user = new UserBuilder(1, "Paco").build();
        assertFalse(user.tagContains("Not"));
    }

    @Test
    void testTagContainsFalse() {
        py.lpz.nelson.pd.builder.user.User user = new UserBuilder(1, "Paco").tag("Director").tag("Socio").phone(666666666).build();
        assertFalse(user.tagContains("Not"));
    }

    @Test
    void testTagContainsTrue() {
        py.lpz.nelson.pd.builder.user.User user = new UserBuilder(1, "Paco").tag("Director").tag("Socio").build();
